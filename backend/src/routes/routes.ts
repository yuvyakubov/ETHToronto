...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { FarmController } from './../monitoring/api/smartContractController';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/route/:id',
            ...
            function FarmController_getTesst(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getTesst.apply(controller, validatedArgs as any);
